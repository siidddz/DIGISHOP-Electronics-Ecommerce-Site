...
def product_details(request,pk):
	...
	for i in carts:
		net_price=net_price+i.total_price
		total_qty=total_qty+i.product_qty
	return render (request,"product-details.html",{'product':product,'wishlist_flag':wishlist_flag,'cart_flag':cart_flag,'carts':carts,'net_price':net_price,'total_qty':total_qty})
